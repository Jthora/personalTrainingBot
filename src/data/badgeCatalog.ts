...
const BADGE_CATALOG: BadgeDefinition[] = [
    ...
    { id: 'streak_7', name: 'Persistent Cadet', description: 'Complete 7 consecutive mission days', rarity: 'rare', icon: '🛡️', tierGroup: 'streak', tier: 2, maxTier: 3, artworkTokenId: 'streak' },
    ...
    { id: 'minutes_60', name: 'Deep Cover', description: 'Log 60 minutes of training in a single day', rarity: 'common', icon: '⏱️', artworkTokenId: 'time' },
    { id: 'minutes_300', name: 'Extended Op', description: 'Log 300 minutes of training in a single week', rarity: 'rare', icon: '✈️', artworkTokenId: 'time' },
    { id: 'completion_10', name: 'Field Initiate', description: 'Complete 10 training exercises', rarity: 'common', icon: '✅', tierGroup: 'completions', tier: 1, maxTier: 3, artworkTokenId: 'completion' },
    { id: 'completion_50', name: 'Signal Analyst', description: 'Complete 50 training exercises', rarity: 'rare', icon: '🧭', tierGroup: 'completions', tier: 2, maxTier: 3, artworkTokenId: 'completion' },
    { id: 'completion_100', name: 'Ace Cadet', description: 'Complete 100 training exercises', rarity: 'epic', icon: '🎖️', tierGroup: 'completions', tier: 3, maxTier: 3, artworkTokenId: 'completion' },
