...
const DISCIPLINE_MAP: Record<string, DisciplineVisual> = {
  agencies:         { id: 'agencies',         icon: '🏛️', color: '#6366f1', bgTint: 'rgba(99, 102, 241, 0.12)' },
  ...
  psiops:           { id: 'psiops',            icon: '🔮', color: '#8b5cf6', bgTint: 'rgba(139, 92, 246, 0.12)' },
  war_strategy:     { id: 'war_strategy',      icon: '♟️', color: '#eab308', bgTint: 'rgba(234, 179, 8, 0.12)' },
  ...
  space_force:      { id: 'space_force',       icon: '🚀', color: '#818cf8', bgTint: 'rgba(129, 140, 248, 0.12)' },
};
