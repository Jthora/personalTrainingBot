...
const palette = (
    partial: Partial<HandlerPalette>,
    defaults: HandlerPalette
): HandlerPalette => ({
    ...defaults,
    ...partial,
});

const basePalette: HandlerPalette = {
    accent: '#5A7FFF',
    accentStrong: '#2B4ACF',
...
export const handlerPalettes: Record<string, HandlerPalette> = {
    default: basePalette,
