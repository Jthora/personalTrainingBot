...
export const CACHE_STORES = ['handlerCatalog', 'moduleCatalog', 'drillCategories', 'scheduleStub', 'drillDetails', 'meta'] as const;
export const CACHE_SCHEMA_VERSION = 1;

export const TTL_MS = {
    handlerCatalog: 24 * 60 * 60 * 1000,
    moduleCatalog: 24 * 60 * 60 * 1000,
    drillCategories: 12 * 60 * 60 * 1000,
