...
const rawWorkoutSubCategories = import.meta.glob("../data/training_handler_data/drills/subcategories/**/*.json", { eager: true });
...
export const totalWorkoutSubCategories = Object.keys(drillSubCategoryData).length;
